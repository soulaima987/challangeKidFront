...
import { EditCoachComponent } from './settings/forms/edit-coach/edit-coach.component';
...
@NgModule({
  ...
  exports: [
    AccountComponent,
    ProfileDetailsComponent,
    EditCoachComponent  // Export components if you want to use them in other modules
  ]
})
